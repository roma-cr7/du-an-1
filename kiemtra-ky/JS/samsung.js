...
// //Gọi hàm hiển thị sản phẩm Samsung
// function displaySamsungProducts() {
//   const container = document.getElementById("samsung-products");
//   container.innerHTML = "";
//   //Lọc các sản phẩm Samsung (id 1 - 6)
//   const samsungProducts = products.filter(p => p.id >= 1 && p.id <= 6);

//   samsungProducts.forEach(product => {
//     container.innerHTML += `
//       <div class="phone--card">
//         <a href="./produs.html" class="phone--produce">
//           <div class="img">
...
//   });
// }
// window.onload = displaySamsungProducts;



// Giả sử bạn đã có cart.js, trong đó định nghĩa sẵn addToCart(id) và updateCartBadge()

// 1. Mảng products như cũ
const products = [
  {id: 1, name: "Samsung Galaxy A15 LTE 8GB 128GB", price: 4290000, image: "./img/IP 15.webp"},
  {id: 2, name: "Samsung Galaxy A36 5G 8GB 128GB", price: 7990000, image: "./img/SS a36.webp"},
  {id: 3, name: "Samsung Galaxy S24 FE 5G 8GB 128GB", price: 12990000, image: "./img/X15 Ultra 5G.webp"},
...
// 2. Hàm hiển thị Samsung
function displaySamsungProducts() {
  const container = document.getElementById("samsung-products");
  if (!container) return console.error("Không tìm thấy #samsung-products");
  container.innerHTML = "";
...
// 3. Khi DOM xong, hiển thị và cập nhật số lượng cart
window.addEventListener("DOMContentLoaded", () => {
  displaySamsungProducts();

  // Nếu bạn có badge hiện số lượng
